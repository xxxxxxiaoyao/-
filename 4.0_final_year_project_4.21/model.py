...
class SRecord(db.Model):
    __tablename__ = 'SRecord'

    SRecord_id = db.Column(db.Integer, primary_key=True)
    action = db.Column(db.String)  # 描述日志行为
    user = db.Column(db.String)               # 可选：记录操作用户
